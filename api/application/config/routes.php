...
$route['api/user/updateUserAdditionalInfo/(:num)']['post'] = 'user/updateUserAdditionalInfo/$1';
$route['api/user/updateUserPassword/(:num)']['post'] = 'user/updateUserPassword/$1';
...
$route['api/user/getAllFinishedLecturesByUserId/(:num)'] = 'user/getAllFinishedLecturesByUserId/$1';
$route['api/user/getAllLatestLecturesByUserId/(:num)'] = 'user/getAllLatestLecturesByUserId/$1';
$route['api/user/getMonthlyActivity/(:num)/(:num)'] = 'user/getMonthlyActivity/$1/$2';
$route['api/user/nextUsernameChangeAvailableIn/(:num)'] = 'user/nextUsernameChangeAvailableIn/$1';
$route['api/user/enrollUserInCourse/(:num)/(:num)'] = 'user/enrollUserInCourse/$1/$2';
$route['api/user/getUserCourseBySlug/(:any)/(:num)'] = 'user/getUserCourseBySlug/$1/$2';
...
$route['api/lecture/getLectureBySlug/(:any)'] = 'lecture/getLectureBySlug/$1';
$route['api/lecture/getLectureHtmlBySlug/(:any)'] = 'lecture/getLectureHtmlBySlug/$1';
...
$route['api/lecture/toggleLectureStatus/(:num)/(:any)'] = 'lecture/toggleLectureStatus/$1/$2';
